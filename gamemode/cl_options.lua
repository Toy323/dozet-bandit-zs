...
GM.RHealth = CreateClientConVar("zsb_rhealth", 140, true, false):GetInt(), 0, 255
cvars.AddChangeCallback("zsb_rhealth", function(cvar, oldvalue, newvalue)
	GAMEMODE.RHealth = math.Clamp(tonumber(newvalue) or 0, 0, 255)
end)
GM.GHealth = CreateClientConVar("zsb_ghealth", 140, true, false):GetInt(), 0, 255
cvars.AddChangeCallback("zsb_ghealth", function(cvar, oldvalue, newvalue)
	GAMEMODE.GHealth = math.Clamp(tonumber(newvalue) or 0, 0, 255)
end)
GM.BHealth = CreateClientConVar("zsb_bhealth", 140, true, false):GetInt(), 0, 255
cvars.AddChangeCallback("zsb_bhealth", function(cvar, oldvalue, newvalue)
