...
function GM:CreateFonts()
	...
	surface.CreateLegacyFont(fontfamily, screenscale * 22 , fontweight, fontaa, false, "ZSHUDFontTiniestStatus2", fontshadow, fontoutline, nil, true)
	surface.CreateLegacyFont(fontfamily, screenscale * 22 , fontweight, fontaa, false, "ZSHUDFontTiniestStatus", fontshadow, fontoutline, nil, true)
	surface.CreateLegacyFont(fontfamily, screenscale * (46), fontweight, fontaa, false, "ZSHUDFontTiniest", fontshadow, fontoutline, nil, true)
...
net.Receive("zs_block_damage", function(length)
	local dmg = net.ReadFloat()
	GAMEMODE:CenterNotify(COLOR_RED, translate.Get("blockeddmg", color_white ,dmg))
end)
