...
GM:AddSkillModifier(SKILL_STOIC1, SKILLMOD_HEALTH, 7)
GM:AddSkillModifier(SKILL_STOIC1, SKILLMOD_SPEED, -7)

GM:AddSkillModifier(SKILL_STOIC2, SKILLMOD_HEALTH, 4)
GM:AddSkillModifier(SKILL_STOIC2, SKILLMOD_SPEED, -10)

GM:AddSkillModifier(SKILL_STOIC3, SKILLMOD_HEALTH, 7)
